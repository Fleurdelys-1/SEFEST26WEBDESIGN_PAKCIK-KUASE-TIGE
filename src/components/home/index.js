...
export default function Home() {
  ...
  return (
    <>
      <main id="home" className="flex flex-col items-start justify-start min-h-screen w-full select-none px-4 sm:px-8 md:px-16 lg:px-24 pt-32 sm:pt-40 md:pt-48 pb-16 lg:relative">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#F4F4F4] text-left mb-4 font-outfit drop-shadow-lg">
          {t('home.title')}
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            className="group relative px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-[#F4F4F4] overflow-hidden transition-all duration-300 hover:scale-105"
            style={{
        ...
        <div className="flex flex-wrap gap-6 sm:gap-8 md:gap-12 mt-12">
          <div>
            <p className="text-xl sm:text-2xl font-bold text-[#F4F4F4]">10,000+</p>
            <p className="text-sm text-[#F4F4F4]/60">Certificates</p>
          </div>
          <div>
            <p className="text-xl sm:text-2xl font-bold text-[#F4F4F4]">500+</p>
            <p className="text-sm text-[#F4F4F4]/60">Institutions</p>
          </div>
          <div>
            <p className="text-xl sm:text-2xl font-bold text-[#F4F4F4]">50,000+</p>
